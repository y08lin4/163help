...
(function() {
    ...
    async function fetchConfig() {
        return new Promise(r => GM_xmlhttpRequest({
            ...
            headers:{'X-Music-Helper-Version': CURRENT_VERSION, 'X-Client-Type': 'docker'},
            onload:res=>{
    ...
    async function claimTicket(ticket) {
        return new Promise(r => GM_xmlhttpRequest({
            ...
            headers:{'Content-Type':'application/json','X-Music-Helper-Version': CURRENT_VERSION, 'X-Client-Type': 'docker'},
